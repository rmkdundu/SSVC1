<%-- 
    Document   : mo_view_officers
    Created on : 17 Apr, 2019, 11:20:20 AM
...
<form id="form1" name="form1" method="post" action="">
  <table width="1184" height="178" border="1">
    ...
    <%
          ...
          ResultSet rs=db.view_officers(lid);
          while(rs.next())
          {
      i++;
      %>
    <tr>
      ...
      <td><a href="send_secret_image.jsp?rid=<%=rs.getString("clogin_id")%>">send image</a></td>
    </tr>
     <% }
    %>
  </table>
